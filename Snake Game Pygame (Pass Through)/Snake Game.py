    ...
    while not gameExit:
        ...
        if snake_pos_x >= display_width or snake_pos_x < 0 or snake_pos_y >= display_height or snake_pos_y < 0:
            ...
            if direction == 'up':
                ...
                snake_head.append(display_height-block_size)
                snake_list.append(snake_head)
                snake_pos_y = display_height-block_size
                
            elif direction == 'down':
                snake_head.append(snake_pos_x)
                snake_head.append(-block_size)
                snake_list.append(snake_head)
                snake_pos_y = -block_size 
                
            elif direction == 'left':
                snake_head.append(display_width-block_size)
                snake_head.append(snake_pos_y)    
                snake_list.append(snake_head)
                snake_pos_x = display_width-block_size   
            
            elif direction == 'right':
                snake_head.append(block_size)
                snake_head.append(snake_pos_y)    
                snake_list.append(snake_head)
                snake_pos_x = block_size   
